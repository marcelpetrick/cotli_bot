...
Global Const $wantedCrusaderPos = 4 ; 4 is Sarah, 5 is Wendy .. and so on
...
Global const $referenceTime = "2017/01/01 00:00:00" ; randomly chosen (anything past the current date works)
